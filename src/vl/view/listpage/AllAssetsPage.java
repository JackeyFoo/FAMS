...
import vl.view.hispage.AssetsHistoryPage;
...
public class AllAssetsPage extends MyTable {
	...
	public void initPopMenu(JPopupMenu popupmenu, final ModelObject o) {
		...
		JMenuItem history = new JMenuItem("资产 " + o.getFormatID() + " 历史动态");
		...
		history.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				new AssetsHistoryPage(jframe, assets);
		...
		if (assets.getAssetindeliverstatus().equals("库中")) {
			...
			if (assets.getAssetindeliverstatus().equals("出库")) {
				...
				JMenuItem deliverouthis = new JMenuItem("资产 " + o.getFormatID()
						+ " 出库历史");
				...
				deliverouthis.addActionListener(new ActionListener() {
			...
			if (assets.getAssetrunningstatus().equals("正常")) {
				...
				if (!assets.getAssetindeliverstatus().equals("借出")) {
					popupmenu.addSeparator();
				...
				discard.addActionListener(new ActionListener() {
					...
					&& !assets.getAssetindeliverstatus().equals("借出")) {
				...
				maintained.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						// TODO Auto-generated method stub
						new MantainFinishedPage(jframe, assets, null);
					}
